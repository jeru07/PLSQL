...
insert into customer values(567,'rithu',53654764,'personal',875,658588);
insert into customer values(67,'jeru',865875,'office',20,9075432);
insert into customer values(7,'jigi',091738663,'personal',45,875635889);
select * from customer;

select max (amount)
from customer; 

SELECT cus_name, amount FROM customer
...
drop table bank;
desc bank;
insert into bank values(5,'axis','chennai',875435,'02-nov-2005','02-aug-2005');
insert into bank values(6,'axis','madurai',86921,'05-nov-2005','05-aug-2005');
insert into bank values(8,'axis','trichy',09809098,'08-nov-2005','08-aug-2005');
insert into bank values(10,'axis','trichy',9098,'08-nov-2005','08-nov-2005');
insert into bank values(11,'axis','theni',976976,'08-dec-2005','08-dec-2005');
insert into bank values(12,'axis','kambam',124348,'08-july-2005','08-july-2005');
select * from bank where activation_date >= '01-aug-2005' and  activation_date <= '10-aug-2005';  

create table alias(
cus_id  number(10) PRIMARY KEY,
acc_num  number(30),
interest_amount number(20)
);
insert into alias values(7,091738663,875635889);
insert into alias values(5,098789,8756);
insert into alias values(89,767565,86439);
select * from alias;

SELECT interest_amount AS alias_name
 from alias ; 
...
--Write a query which will display the customer id, account type they hold, their account number and bank name.
...
--*Write a query which will display the customer id, customer name, gender, marital status along with the unique reference string and
...
--Write a query which will display the account number, customer id, registration date, initial deposit amount of the customer
...
--Write a query which will display customer id, customer name, date of birth, guardian name of the customers whose name starts with 'J'.
...
--.*Write a query which will display the customer id, customer name, date of birth, Marital Status, Gender, Guardian name, 
...
--Write a query which will display the customer id, customer name, guardian name, reference account holders name of the customers 
...
--Write a query to display the customer id, account number and interest amount in the below format with INTEREST_AMT as alias name
...
--*Write a query which will display the customer id, customer name, account no, account type, activation date,
...
--Write a query which will display customer id, customer name, date of birth, guardian name, contact number,
...
--Write a query to display the customer id, customer name, account number, account type, initial deposit, 
...
--*Write a query to display the customer id, customer name, account number, account type, interest, bank name 
...
--Write a query to display the customer id, customer name, account no, bank name, contact no 
...
--Write a query which will display customer id, bank name, branch name, ifsc code, registration date, 
...
--Write a query which will calculate the interest amount and display it along with customer id, customer name, 
...
--Write a query to display the customer id, customer name, date of birth, guardian name, contact number, 
...
--"Write a query which will display the customer id, customer name and contact number with ISD code of 
...
--Write a query which will display account number, account type, customer id, customer name, date of birth, guardian name, 
...
--Write a query which will display customer id, customer name,  guardian name, identification doc type,
...
--"Write a query which will display the customer id, customer name, account number, account type, interest, initial deposit;
...
--Write a query which will display customer id, customer name,  account number, account type, bank name, ifsc code, initial deposit amount
...
--Write query to display the customer id, customer name, account no, initial deposit, tax percentage as calculated below.
